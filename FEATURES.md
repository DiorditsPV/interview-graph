...
| `feature/hide-local` | hide-local | Скрыть вопрос с доски (локально) | done | pass (build + pytest 11 + smoke 9/9) | ok (нет замечаний — сигнатура/вызов синхронны, hidden вливается в dimmed, drawer-кнопка работает на скрытом) | 2026-05-30 | .claude/features/hide-local.md |
